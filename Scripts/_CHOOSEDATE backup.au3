...
Func _CHOOSEDATE_ShowGUI($MON = @MON, $YEAR = @YEAR, $type = 1,$hGUI ='')
	...
	_GUICtrl_OnHoverRegister(-1, "_ChooseDateHover", "_ChooseDateNormal", "_Nothing", "_ChooseDateClick")
	...
	For $i = 0 To 7 * 6 - 1
		...
		GUICtrlSetColor(-1, "0xFFFFFF")
		GUICtrlSetBkColor(-1, "-2")
		_GUICtrl_OnHoverRegister($CHOOSEDATE_Date[$i], "_ChooseDateHover", "_ChooseDateNormal", "_Nothing", "_ChooseDateClick")
	Next
